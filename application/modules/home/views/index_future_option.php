      ...
      <section class="innerpage_banner">
        ...
        <div class="innr_bnr_cap">
          <div class="container">
            <div class="row">
              <div class="col-sm-6">
                <h1 class="inr_banner_head">Index Future Option</h1>
              </div>
              <div class="col-sm-6">
                <div class="bredcrumb_main">
                  <ol class="breadcrumb">
                    <li><a href="<?php echo base_url(); ?>">Home</a></li>
                    <li class="active">Index Future Option</li>
                  </ol>
                </div>
              </div>
            </div>
...
<!--              <div class="since_text">Since 2007</div>-->
              ...
              <p class="pera_bottom_20"> Nifty is the index of NSE which indicates the status and movement of shares / stocks listed in NSE,
