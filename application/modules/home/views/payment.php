...
<?php } ?></td>
                                ...
                                <tr>
                                    ...
                                    <td>Full Name: </td>
                                    <td><input class="form-control" required="" placeholder="Name" name="firstname" id="firstname" value="<?php echo (empty($posted['firstname'])) ? '' : $posted['firstname']; ?>" /></td>
                                </tr>
                                <tr>
                                    <td>Email: </td>
              ...
              <div class='form-group card required'>
                  <div class="col-md-offset-9">
                      <?php if (!$hash) { ?>
                                            <img src="<?php echo base_url(); ?>frontend_asset/images/payumoney_logo.png" class="img-responsive">    <br>   <input class="btn btn-warning btn-lg" type="submit" value="Submit" />
                  <?php } ?></div>
              </div>
            </div>
                        </form>
