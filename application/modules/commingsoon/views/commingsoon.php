...
<html lang="en">
  <head>
    ...
    <meta name="keywords" content="Equity Reasearch">
    <link href='https://fonts.googleapis.com/css?family=Lobster|Open+Sans:400,400italic,300italic,300|Raleway:300,400,600' rel='stylesheet' type='text/css'>
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>commingsoon_asset/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>commingsoon_asset/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>commingsoon_asset/css/animate.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>commingsoon_asset/css/style.css">
      ...
      <div class="container wow fadeInUp delay-03s">
        <div class="row">
          <div class="logo text-center">
            <img src="<?php echo base_url();?>commingsoon_asset/img/Under-construction.png" alt="under construction" width="150">
            <h2>We Are Baking Something New!! Comming Soon</h2>
          </div>

<!--          <div id="countdown" data-wow-delay=".3s" data-date="Dec 26, 2016 06:00:00"></div>-->
          <h2 class="subs-title text-center">We are currently working to finish our new awesome website!!!</h2>
...
<!--    <footer class="footer">
         ...
         <div class="row bort">
           ...
           <div class="copyright">
                ...
                <div class="credits">
                    ...
                    Develop by <a href="<?php echo base_url();?>"><?php echo SITE_NAME;?></a>
                </div>
           </div>
    ...
    <script src="<?php echo base_url();?>commingsoon_asset/js/jquery.min.js"></script>
    <script src="<?php echo base_url();?>commingsoon_asset/js/bootstrap.min.js"></script>
<!--    <script src="<?php echo base_url();?>commingsoon_asset/js/jquery.countdown.min.js"></script>
    <script src="<?php echo base_url();?>commingsoon_asset/js/wow.js"></script>
    <script src="<?php echo base_url();?>commingsoon_asset/js/custom.js"></script>
    <script src="<?php echo base_url();?>commingsoon_asset/contactform/contactform.js"></script>-->
