                    ...
                    <div class="form-body">
                        <div class="row">
                           ...
                           <div class="col-md-12" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       <select class="form-control" name="company_name" id="company_name">
                                            <option value=""><?php echo lang('choose_company');?></option>
                                            <?php if(!empty($organization)){foreach($organization as $rows){?>
                                              <option value="<?php echo $rows->id;?>" <?php echo ($results->org_id == $rows->id) ? "selected" : "";?>><?php echo $rows->name;?></option>
                                            <?php }}?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12" >
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><?php echo lang('roles');?></label>
                                    <div class="col-md-9">
                                       <select class="form-control" name="role_id" id="role_id">
                                            <option value=""><?php echo lang('choose_role');?></option>
                                            <?php if(!empty($roles)){foreach($roles as $rows){?>
                                              <option value="<?php echo $rows->id;?>" <?php echo ($results->g_id == $rows->id) ? "selected" : "";?>><?php echo $rows->name;?></option>
                                            <?php }}?>
                                        </select>
                                    </div>
                                </div>
