    ...
    <body>
        <div class="table">
            <div class="table-row">
                ...
                <div class="table-cell1"> <b>Assessment Type:</b>180 Assessment Reports
                    <div></div>
                </div>
            </div>
            <div class="table-row">
            ...
            <?php $j=1; foreach($salesRepData as $sales){?>
             <div class="table-row">
                 <div class="table-cell" colspan="3">    
                     <div class="text-heading-view"><?php echo $title; ?>  
           ...
           <?php         $category = category180Report($sales['id'],$sales['user_assessment_id']);
            ...
            <?php  $i=1;if (!empty($category['category'])) {
                        foreach ($category['category'] as $cat) {
                            ...
                            <div class="table-row">
                                <div class="table-cell" colspan="3">
                                    <b>Category: </b> <span class="category-heading"><?php echo $statement['category_name']; ?></span>
                                </div>
                            </div>
                            <div class="table-row">
                                <div class="table-cell" colspan="3">
                                     <canvas id="lineChart<?php echo $i;?>"></canvas>
                                     <script>
                                            var lineData = {
